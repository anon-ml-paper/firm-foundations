...
import random
from firm_foundations.datasets import DatasetDictWithMetadata, DatasetWithMetadata, load_dataset_with_metadata
import numpy as np
...
PATH = "pile/aria2-1.37.0-linux-gnu-64bit-build1/pythia/intermediate_npys_final"
...
def main():
    ...
    for step in X:
        ...
        obj.push_to_hub(f"anonymous-ml-paper/pythia_dedupe_mia_{preA}-{preB}_{postA}-{postB}")
        del obj
        ...
        obj.push_to_hub(f"anonymous-ml-paper/pythia_dedupe_mia_{preA}-{preB}_{step}-{ENDSTEP}")
        del obj
        ...
        obj.push_to_hub(f"anonymous-ml-paper/pythia_dedupe_mia_0-{step}_{step}-{ENDSTEP}")
        del obj
        ...
        obj.push_to_hub(f"anonymous-ml-paper/pythia_dedupe_mia_0-{step}_{postA}-{postB}")
        del obj
