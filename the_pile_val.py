...
_HOST_URL = "https://huggingface.co"

_DATA_URLS = {
    "all": {
        "validation": [f"{_HOST_URL}/datasets/monology/pile-uncopyrighted/resolve/main/val.jsonl.zst"]
    },
    # Everything under here is no longer accessible via this script. 
    ...
    def _split_generators(self, dl_manager):
        ...
        if self.config.name == "all":
            ...
            return [
                ...
                for split in [datasets.Split.VALIDATION]
            ]
        else:
